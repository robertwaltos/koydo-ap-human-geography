...
export const metadata: Metadata = {
  title: "Koydo AP Human Geography — Free Exam Prep",
  description: "Comprehensive AP Human Geography preparation. Practice tests, AI tutor, score tracking. This app is an independent study aid and is not affiliated with, endorsed by, or approved by AP or any official testing authority. All trademarks belong to their respective owners.",
};
    ...
    <main className="min-h-screen">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-[var(--accent)] to-[var(--accent-dark)] px-4 py-20 text-white">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <h1 className="mb-6 text-4xl font-extrabold tracking-tight sm:text-5xl md:text-6xl">
            Ace AP Human Geography with Koydo
          </h1>
      ...
      <section className="mx-auto max-w-5xl px-4 py-16">
        <h2 className="mb-10 text-center text-2xl font-bold text-zinc-900 dark:text-zinc-100">
          Why Koydo for AP Human Geography?
        </h2>
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {[
            { icon: "📝", title: "Practice Tests", desc: "Hundreds of practice questions matching the real AP Human Geography format." },
