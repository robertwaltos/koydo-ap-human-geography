...
const EXAM_ID = "ap-human-geography";
const EXAM_DISPLAY_NAME = "AP Human Geography";

const TUTOR_SYSTEM_PROMPT = `You are an expert AI tutor for ${EXAM_DISPLAY_NAME}. Respond in English.

Cover Thinking Geographically, Population & Migration, Cultural Patterns, Political Patterns, Agriculture, Cities, and Industrial Development. Align to College Board AP Human Geography CED.
