...
export const metadata: Metadata = {
  title: "Pricing — Ap Human Geography Premium",
  description: "Unlock unlimited Ap Human Geography practice with Koydo Premium.",
};

export default function PricingPage() {
  const checkoutUrl = `https://koydo.app/pricing?exam=ap-human-geography&cadence=annual`;
